...
<div class="content" id="membersList">
    <div class="row">
        ...
        <div class="input-field col s2">
            <a class="waves-effect waves-light btn-small green right mainColorBackground" href="{{ route('corporate.members.create') }}"><i class="material-icons left">add</i>Add</a>
        </div>
        @endif
    </div>
    <div class="row">
...
window.Laravel.isCorporate  = true;
</script>
