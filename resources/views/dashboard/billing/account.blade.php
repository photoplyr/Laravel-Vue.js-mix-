...
<div class="wrapper" id="billingAccount">
    ...
    <div class="billingAccountHeader">
        ...
        <div class="buttons right">
            <a :href="'/billing/account/download/transactions?year='+ selectedYear.id +'&month='+selectedMonth.id +'&company_id='+selectedCompany.id" class="button small dark with-icon-left"><span class="material-icon material-icons-outlined">file_download</span>Download Transactions</a>
            <a :href="'/billing/account/download/insurance?year='+ selectedYear.id +'&month='+selectedMonth.id +'&company_id='+selectedCompany.id" class="button small dark with-icon-left"><span class="material-icon material-icons-outlined">file_download</span>Download Insurance</a>
        </div>
    </div>

    <h5 class="newTitle right hiddenOnMobile" style="width: 650px;">@{{ info.selectedMonthFull }} Estimated Reimbursement  <b>$@{{ info.totalPayout }}</b> Total Oustanding  <b>$@{{ info.outstandingPayout }}</b></h5>
