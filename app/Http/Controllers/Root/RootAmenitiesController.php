...
class RootAmenitiesController extends \App\Http\Controllers\Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('dashboard.root.amenities.index', [
            'list' => $list,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.root.amenities.manage', [
            'amenity' => $amenity,
        ]);
    }
    ...
    public function save($id)
    {
        ...
        return redirect(route('root.amenities'))->with('successMessage', 'Changes saved');
    }
}
